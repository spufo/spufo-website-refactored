const itTranslations = {
  translation: {
    ...
    feature2: {
      title: 'Modifica delle immagini direttamente nell\'app',
      description: 'Le immagini possono essere modificate direttamente all\'interno dell\'app, eliminando la necessità di software aggiuntivi.',
      link: 'Vai alla panoramica delle funzionalità'
    },
    feature3: {
    ...
    forensicSuccess: {
      title: 'Successo operativo con la Polizia Cantonale di Zurigo',
      subtitle: 'Come SPUFO sta rivoluzionando la fotografia forense delle impronte digitali nelle operazioni di polizia reali',
      adoption: {
        title: 'Adozione su larga scala a Zurigo',
        description: 'SPUFO ha raggiunto traguardi significativi nella sua introduzione nelle forze dell\'ordine di Zurigo:',
        points: [
          'Implementato da FOR Zurich da aprile 2024',
          'Adottato completamente dalla Polizia Cantonale (KAPO) da ottobre 2024',
          'Attualmente in uso quotidiano da migliaia di agenti di polizia'
        ]
      },
      efficiency: {
        title: 'Efficienza delle indagini migliorata',
        description: 'Ottimizzando il processo di fotografia delle impronte digitali, SPUFO ha ridotto significativamente il tempo necessario per la raccolta delle prove sulle scene del crimine. Questa efficienza consente alle squadre forensi di gestire più casi garantendo la massima qualità delle prove.'
      },
      standard: {
        title: 'Standard professionale',
        description: 'SPUFO continua a essere lo strumento standard per la fotografia forense delle impronte digitali utilizzato dalla polizia di Zurigo, dimostrando la sua efficacia e affidabilità in scenari reali di applicazione della legge.'
      }
    },
