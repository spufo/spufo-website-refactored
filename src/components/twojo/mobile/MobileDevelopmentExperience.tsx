...
const MobileDevelopmentExperience: React.FC = () => {
  const { t } = useTranslation();

  const experience = [
    {
      icon: Smartphone,
      title: t('twojo.mobile.experience.0.title'),
      description: t('twojo.mobile.experience.0.description')
    },
    {
      icon: Camera,
      title: t('twojo.mobile.experience.1.title'),
      description: t('twojo.mobile.experience.1.description')
    },
    {
      icon: User,
      title: t('twojo.mobile.experience.2.title'),
      description: t('twojo.mobile.experience.2.description')
    }
  ];
...
export default MobileDevelopmentExperience;
