  ...
  return (
    <section className="py-24 px-6 bg-gray-100 text-[#1E1E2E]">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-7xl font-bold text-[#FF6600] mb-12 text-center">Testimonial</h2>
        <div className="relative">
          ...
          <blockquote className="text-2xl md:text-4xl font-light italic text-center mb-8 relative z-10">
            «Das Beispiel 
            <span className="text-[#FF6600] font-normal hover:scale-[1.02] transition-all duration-300 inline-block mx-2">SPUFO</span>
             zeigt auf, wie bedeutsam neue Technologien
             auch für die Kriminaltechnik sind.» ...<br/> 
             «Die App sorgt für deutlich  
             <span className="text-[#FF6600] font-normal hover:scale-[1.02] transition-all duration-300 inline-block mx-2">mehr Effizienz</span> 
             und vor allem  
             <span className="text-[#FF6600] font-normal hover:scale-[1.02] transition-all duration-300 inline-block mx-2">mehr eingelieferte Spuren</span>.»
          </blockquote>
