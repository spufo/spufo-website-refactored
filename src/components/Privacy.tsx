  ...
  return (
    <section className="relative text-[#1E1E2E] overflow-hidden flex flex-col">
      ...
      <div className="flex-grow flex flex-col max-w-5xl mx-auto py-24 px-6 mt-24 z-10">
        <h1 className="text-7xl font-bold text-[#FF6600] mb-12 text-center">Privacy Statement</h1>
        <div className="flex flex-col items-center">
          ...
          <h4 className="text-lg font-semibold mt-6 mb-2 text-center">Storage Duration</h4>
          <p className="text-lg mb-2 text-center">The specific storage duration of the processed data is not determined by us but is determined by Fonticons, Inc. Further information can be found in the privacy policy for Font Awesome CDN: <a href="https://cdn.fontawesome.com/privacy" className="text-[#FF6600] hover:underline">Font Awesome Privacy Policy</a>.</p>
        </div>
      </div>
    </section>
  );
