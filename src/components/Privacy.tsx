...
const PrivacyStatement = () => {
  return (
    <section className="relative text-white bg-black overflow-hidden flex flex-col">
      ...
      <div 
        className="absolute sm:-translate-y-40 -translate-x-[80rem] sm:-translate-x-[60rem] rotate-[46deg] sm:rotate-[64deg] scale-[1] sm:scale-[0.9] inset-0 bg-no-repeat bg-center opacity-10 z-0 pointer-events-none"
      >
        <img src={background} alt="Background" />
      </div>

      <div className="flex-grow flex flex-col max-w-5xl mx-auto py-24 px-6 mt-24 z-10">
        <h1 className="text-4xl md:text-7xl font-bold text-cyan-400 mb-12 text-center">Privacy Statement</h1>
        <div className="flex flex-col items-center">
          ...
          <h4 className="text-lg font-semibold mt-6 mb-2 text-center">Storage Duration</h4>
          <p className="text-lg mb-2 text-center">The specific storage duration of the processed data is not determined by us but is determined by Fonticons, Inc. Further information can be found in the privacy policy for Font Awesome CDN: <a href="https://cdn.fontawesome.com/privacy" className="text-cyan-400 hover:underline">Font Awesome Privacy Policy</a>.</p>
        </div>
      </div>
    </section>
  );
